...
namespace StatefulT4Processor.T4StateManager.Registration
{
    public class RegisterInterfaceToSingleImplementations2 : InterfaceToSingleImplementationRegistrationConvention
    {
        protected override IEnumerable<Assembly> GetAssembliesToScan()
        {
			return new[] { typeof(T4StateContext).Assembly };
        }
    }
