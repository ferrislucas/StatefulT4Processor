<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<StatefulT4Processor.DeploymentManager.Models.IndexViewModel>" %>
	...
	<% if (Model.Deployments.Count() > 0) { %>
		...
		<% Html.Grid(Model.Deployments)
		   .Columns(column =>
		   {
			   ...
			   column.For(item => Html.ActionLink("Execute", "Execute", new { id = item.Id }, null)).Named(string.Empty);
